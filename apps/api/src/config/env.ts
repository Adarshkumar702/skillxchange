...
export const ENV = {
  ...
  ALLOWED_ORIGINS: process.env.ALLOWED_ORIGINS || 'http://localhost:3000,http://127.0.0.1:3000,https://skillxchange-web.vercel.app',
  ...
  SEED_ADMIN_EMAIL: process.env.SEED_ADMIN_EMAIL || 'admin@adarsh.com',
  SEED_ADMIN_PASSWORD: process.env.SEED_ADMIN_PASSWORD || '1234',
