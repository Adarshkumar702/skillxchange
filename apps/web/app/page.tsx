...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative pt-20 pb-28 px-6 overflow-hidden">
        <div className="max-w-5xl mx-auto text-center space-y-8 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            <Link href="/dashboard/discover" className="px-8 py-3.5 text-base font-semibold rounded-lg bg-white dark:bg-grey-800 border border-slate-300 dark:border-grey-700 text-slate-800 dark:text-slate-200 hover:border-slate-400 transition-all w-full sm:w-auto text-center shadow-sm">
              Explore Skills
            </Link>
          </div>

          {/* Stats Bar */}
          <div className="pt-12 grid grid-cols-2 md:grid-cols-4 gap-4 border-t border-slate-300 dark:border-grey-800 max-w-4xl mx-auto">
            <div>
      ...
      {/* How It Works */}
      <section className="py-20 px-6 bg-slate-200/50 dark:bg-surface/50 border-y border-slate-300 dark:border-surfaceBorder">
        <div className="max-w-6xl mx-auto space-y-12">
          <div className="text-center space-y-3">
            <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white">How SkillXchange Works</h2>
            <p className="text-sm font-medium text-slate-600 dark:text-slate-400">Master new competencies in 4 simple steps.</p>
          </div>
